    ...
    Plugin.prototype = {
        ...
        setDimensions: function(){
            ...
            this.$li.each(function(index) {
                ...
                if(cover){
                    ...
                    $self.css({minHeight: sHeight, zIndex: 999-index})
        ...
        setHash: function(hash){
            ...
            if(history.pushState) {
				...
				jQuery('.top_menu ul li').each(function() {
					jQuery(this).removeClass('mn_active');
				});
				switch(hash) {
					case 'section-1':
						jQuery('.top_menu ul li').css('color', '#a9a9a9');
						jQuery('.mn_home').addClass('mn_active');
					break;
					case 'section-2':
						jQuery('.top_menu ul li').css('color', '#a9a9a9');
						jQuery('.mn_reel').addClass('mn_active');
					break;
					case 'section-7':
						jQuery('.top_menu ul li').css('color', '#a9a9a9');
						jQuery('.mn_contacts').addClass('mn_active');
					break;
					default:
						jQuery('.top_menu ul li').css('color', '#a9a9a9');
						jQuery('.mn_projects').addClass('mn_active');
					break;
				}
            }
            else {
