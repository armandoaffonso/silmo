...
<div id="infinite-handle">
	<a id="load-more-posts" class="load-more-posts" href="#" data-archive='<?php echo json_encode( $archive_type ) ?>'><?php echo apply_filters( 'stag_load_more_text', __( 'Load More', 'stag' ) ); ?></a>
</div>
<?php endif;
